          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-[8px] sm:text-[10px] text-emerald-200/70 whitespace-pre-wrap text-center max-w-xs overflow-auto max-h-[150px]">
                {`'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            This project was originally built on Lovable.\n\n\n\nBefore any migration, determine which Supabase project is the official production backend managed by Lovable.\n\n\n\nIf \`oveuimwssgsadagddtef\` is the official production backend for this Lovable project, DO NOT migrate anything.\n\n\n\nInstead, keep all Smart Notification features in the existing production project.\n\n\n\nOnly migrate to \`llicfiepatzgllmjhzbw\` if there is a confirmed technical requirement and no production data, authentication, storage, or existing functionality will be affected.\n\n\n\nFirst explain which project is the canonical production backend for this Lovable project and why.\n\n\n\nDo not perform any migration until this is confirmed.`}
              </p>
            </motion.div>
