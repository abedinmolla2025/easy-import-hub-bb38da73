          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-[8px] sm:text-[10px] text-emerald-200/70 whitespace-pre-wrap text-center max-w-xs overflow-auto max-h-[150px]">
                {`'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            The sandbox path is not accessible.\n\n\n\nPlease provide the migration file as a real downloadable attachment.\n\n\n\nDo NOT give a sandbox path.\n\n\n\nEither:\n\n\n\n1. Attach full_migration.sql.zip directly to the chat.\n\n\n\nOR\n\n\n\n2. Upload it as a downloadable artifact.\n\n\n\nOR\n\n\n\n3. Commit it to the GitHub repository under:\n\n/supabase/migrations/full_migration.sql.zip\n\n\n\nOR\n\n\n\n4. Split it into multiple SQL files and attach them.\n\n\n\nI need an actual downloadable file, not a sandbox path.`}
              </p>
            </motion.div>
