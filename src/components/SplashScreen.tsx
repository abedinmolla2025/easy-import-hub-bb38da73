          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-[8px] sm:text-[10px] text-emerald-200/70 whitespace-pre-wrap text-center max-w-xs overflow-auto max-h-[150px]">
                {`'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            Do not summarize the migration.\n\n\n\nProvide the actual migration file.\n\n\n\nI need:\n\n\n\n1. The complete file:\n\n   migrations/full_migration.sql\n\n\n\n2. The file must contain:\n\n- All 34 tables\n\n- All data\n\n- All 12 SQL functions\n\n- All triggers\n\n- All indexes\n\n- All 80+ RLS policies\n\n- All 7,220 Hadith records\n\n- All 1,150 Notification templates\n\n- Islamic events\n\n- App settings\n\n\n\n3. If the file is too large, export it as:\n\n\n\nfull_migration.sql.zip\n\n\n\nor\n\n\n\nfull_migration.sql.gz\n\n\n\nor upload it as an artifact for download.\n\n\n\nDo NOT provide a summary.\n\n\n\nI need the complete SQL migration file ready to import into my Supabase project.`}
              </p>
            </motion.div>
