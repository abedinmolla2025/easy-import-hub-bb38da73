          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-[8px] sm:text-[10px] text-emerald-200/70 whitespace-pre-wrap text-center max-w-xs overflow-auto max-h-[150px]">
                {`'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            Connect and deploy this implementation to my existing Supabase project.\n\n\n\nProject URL:\n\nhttps://llicfiepatzgllmjhzbw.supabase.co\n\n\n\nIMPORTANT\n\n\n\nDo NOT create a new Supabase project.\n\n\n\nUse ONLY this existing production project.\n\n\n\nTasks:\n\n\n\n1. Connect the project to the above Supabase instance.\n\n\n\n2. Create all required database objects in this project:\n\n   - notification_templates\n\n   - notification_logs\n\n   - islamic_events\n\n   - any required indexes\n\n   - RLS policies\n\n   - SQL functions\n\n   - triggers\n\n\n\n3. Create and deploy all required Supabase Edge Functions.\n\n\n\n4. Configure pg_cron for automatic notifications.\n\n\n\n5. Configure scheduled jobs:\n\n   - Morning: 7:00 AM\n\n   - Friday: 11:30 AM\n\n   - Evening: 7:00 PM\n\n   - Night: 9:30 PM\n\n\n\nTimezone:\n\nAsia/Kolkata\n\n\n\n6. Populate the database with authentic Islamic notification templates.\n\n\n\n7. Populate authentic Islamic historical events.\n\n\n\n8. Enable Smart Rotation.\n\n\n\n9. Enable Smart Content Selection.\n\n\n\n10. Verify that all existing Noor App data remains intact.\n\n\n\nDO NOT delete or overwrite any existing data, tables, storage buckets, authentication users, RLS policies, or Edge Functions unless absolutely necessary.\n\n\n\n11. Run database migrations safely.\n\n\n\n12. Deploy all changes to production.\n\n\n\n13. Test the complete notification workflow.\n\n\n\n14. Verify:\n\n- Scheduler\n\n- Edge Functions\n\n- Database\n\n- Notification delivery\n\n- Rotation\n\n- Logging\n\n- Analytics\n\n\n\n15. At the end, provide a complete production deployment report including:\n\n- SQL migrations executed\n\n- Tables created\n\n- Functions deployed\n\n- Cron jobs created\n\n- Templates inserted\n\n- Islamic events inserted\n\n- Test results\n\n- Any remaining issues\n\n\n\nThis must be implemented directly in my existing production Supabase project:\n\nhttps://llicfiepatzgllmjhzbw.supabase.co\n\n\n\nDo not use a local database or a new Supabase project.`}
              </p>
            </motion.div>
