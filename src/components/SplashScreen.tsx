          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-[8px] sm:text-[10px] text-emerald-200/70 whitespace-pre-wrap text-center max-w-xs overflow-auto max-h-[150px]">
                {`'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            Run one real production Smart Notification.\n\n\n\nVerify and report:\n\n\n\n1. A notification is selected by get_next_smart_notification().\n\n2. The notification is successfully delivered.\n\n3. A new row is inserted into notification_logs.\n\n4. The next notification selected is different (rotation works).\n\n5. Return the exact notification title and notification_logs row count after the test.`}
              </p>
            </motion.div>
