          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-[8px] sm:text-[10px] text-emerald-200/70 whitespace-pre-wrap text-center max-w-xs overflow-auto max-h-[150px]">
                {`'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            Stop using the Lovable managed Supabase project (oveuimwssgsadagddtef).\n\n\n\nMigrate the entire Noor App to my own Supabase project:\n\n\n\nhttps://llicfiepatzgllmjhzbw.supabase.co\n\n\n\nThis includes:\n\n- Authentication\n\n- Database schema\n\n- All data\n\n- Storage buckets\n\n- Edge Functions\n\n- pg_cron jobs\n\n- Secrets\n\n- Smart Notification System\n\n- Notification templates\n\n- Islamic events\n\n- RLS policies\n\n- SQL functions\n\n- Triggers\n\n\n\nAfter migration, update all environment variables and remove every dependency on the Lovable managed Supabase project.\n\n\n\nFinally, verify that the application communicates only with my Supabase project (llicfiepatzgllmjhzbw) and no longer references oveuimwssgsadagddtef.`}
              </p>
            </motion.div>
