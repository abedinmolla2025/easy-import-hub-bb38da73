          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-[8px] sm:text-[10px] text-emerald-200/70 whitespace-pre-wrap text-center max-w-xs overflow-auto max-h-[150px]">
                {`'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            Proceed with the migration ONLY after performing a complete pre-migration audit.\n\nRequirements:\n\n1. Compare both Supabase projects:\n\n   - oveuimwssgsadagddtef (current)\n\n   - llicfiepatzgllmjhzbw (target)\n\n2. Generate a complete migration plan including:\n\n   - Tables\n\n   - Views\n\n   - Functions\n\n   - Triggers\n\n   - RLS Policies\n\n   - Auth configuration\n\n   - Storage Buckets\n\n   - Edge Functions\n\n   - pg_cron jobs\n\n   - Secrets\n\n   - Notification templates\n\n   - Islamic events\n\n3. Identify anything that would be lost or changed during migration.\n\n4. Export everything from the current project before making any changes.\n\n5. Verify that the target project has:\n\n   - Auth configured\n\n   - Storage configured\n\n   - Existing Noor App tables\n\n   - Existing users remain intact\n\n6. Do NOT execute the migration yet.\n\n7. Return a detailed migration report with:\n\n   - What will be copied\n\n   - What already exists\n\n   - What conflicts exist\n\n   - Estimated migration time\n\n   - Rollback plan\n\nWait for my approval before making any changes.`}
              </p>
            </motion.div>
