          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-[8px] sm:text-[10px] text-emerald-200/70 whitespace-pre-wrap text-center max-w-xs overflow-auto max-h-[150px]">
                {`'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            Before considering the migration complete, perform a final verification.\n\nAnswer only with facts.\n\n1. Is the Noor App fully functional using only my Supabase project (llicfiepatzgllmjhzbw)?\n\n2. Which required database objects are STILL missing from my Supabase?\n\n3. Generate ONE complete SQL migration file that includes:\n\n- All 34 tables\n\n- All RLS policies\n\n- All triggers\n\n- All SQL functions\n\n- All indexes\n\n- All Edge Function dependencies (where applicable)\n\n- The complete Smart Notification schema\n\n- 7,220 Hadith records\n\n- 1,150 notification templates\n\n- Islamic events\n\n- Required app settings\n\n4. Ensure the migration is idempotent (safe to run more than once).\n\n5. After applying the SQL, provide a checklist to verify that Noor App is fully operational on my Supabase project without any dependency on the Lovable managed project.`}
              </p>
            </motion.div>
