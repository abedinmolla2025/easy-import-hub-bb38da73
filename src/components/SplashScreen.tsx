          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-[8px] sm:text-[10px] text-emerald-200/70 whitespace-pre-wrap text-center max-w-xs overflow-auto max-h-[150px]">
                {`'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            I want to verify the Smart Notification System.\n\n\n\nPlease tell me exactly which database is managing the notification system.\n\n\n\nSpecifically answer:\n\n\n\n1. Which database is being used?\n\n   (Supabase PostgreSQL / Local SQLite / In-memory / Mock data / Other)\n\n\n\n2. Which Supabase project is connected?\n\n   Please provide the Project Reference ID.\n\n\n\n3. Which schema contains these tables?\n\n   - notification_templates\n\n   - notification_logs\n\n   - islamic_events\n\n\n\n4. Which database is queried by the Edge Function \`smart-notification-worker\`?\n\n\n\n5. Which database is queried by \`get_next_smart_notification()\`?\n\n\n\n6. Is the system reading from the LIVE production database or from local/demo/mock data?\n\n\n\n7. Confirm that all notifications are generated from the production Supabase database:\n\nhttps://llicfiepatzgllmjhzbw.supabase.co\n\n\n\nPlease provide evidence (SQL query results or configuration) instead of an implementation summary.`}
              </p>
            </motion.div>
