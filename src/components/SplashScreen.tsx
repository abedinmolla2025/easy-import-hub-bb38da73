          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-[8px] sm:text-[10px] text-emerald-200/70 whitespace-pre-wrap text-center max-w-xs overflow-auto max-h-[150px]">
                {`'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            Before making any further changes, answer only this:\n\n\n\nWhy is the application connected to Supabase project:\n\n\n\noveuimwssgsadagddtef\n\n\n\ninstead of\n\n\n\nllicfiepatzgllmjhzbw ?\n\n\n\nWhich project is the REAL production database for Noor App?\n\n\n\nIf oveuimwssgsadagddtef is the production project, explain why.\n\n\n\nIf llicfiepatzgllmjhzbw should be the production project, migrate the entire Smart Notification System to that project and update every environment variable, Edge Function, and cron job accordingly.\n\n\n\nDo not modify anything until you explain which project is the actual production database.`}
              </p>
            </motion.div>
