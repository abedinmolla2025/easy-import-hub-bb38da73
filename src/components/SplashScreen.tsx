          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-[8px] sm:text-[10px] text-emerald-200/70 whitespace-pre-wrap text-center max-w-xs overflow-auto max-h-[150px]">
                {`'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            IMPORTANT:\n\n\n\nThis entire feature is ONLY for Push Notifications.\n\n\n\nIt must NOT modify the Splash Screen, Home Page, Stories, Dua pages, Hadith pages, or any other UI except the Smart Notification Center.\n\n\n\nThe generated content is used exclusively for Web Push Notifications and future Mobile Push Notifications.`}
              </p>
            </motion.div>
