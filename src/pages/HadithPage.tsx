  ...
  return (
    ...
    >
      ...
      <section className="mx-auto max-w-lg px-4 pb-6">
        <h2 className="mb-3 text-lg font-bold text-white">সহীহ বুখারী নির্বাচিত হাদিস</h2>
          ...
          {HADITH_ARTICLES.map((hadith, i) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <h2 className="text-[15px] font-bold leading-snug text-gray-900">{hadith.title}</h2>
                <p className="mt-1 line-clamp-2 text-[12px] leading-5 text-gray-500">{hadith.preview}</p>
                <p className="mt-1 text-[11px] text-gray-400">{hadith.reference}</p>
              </div>
