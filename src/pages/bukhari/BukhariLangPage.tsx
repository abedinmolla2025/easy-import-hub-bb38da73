...
const bukhariChapterNames: Record<number, { bn: string; en: string; ur: string }> = {
  ...
  31: { bn: "খোরাক ও ভরণ-পোষণ", en: "Supporting the Family", ur: "نفقہ" },
  32: { bn: "খাবার", en: "Food, Meals", ur: "کھانے" },
  33: { bn: "আকীকা", en: "Aqiqa", ur: "عقیقہ" },
  34: { bn: "শিকার ও যবেহ", en: "Slaughtering and Hunting", ur: "ذبح اور شکار" },
  35: { bn: "কুরবানী", en: "Sacrifice (Udhiyah)", ur: "قربانی" },
  36: { bn: "পানীয়", en: "Drinks", ur: "مشروبات" },
  37: { bn: "রোগীদের চিকিৎসা", en: "Patients, Medicine", ur: "مریضوں کا علاج" },
  38: { bn: "পোশাক", en: "Dress", ur: "لباس" },
  39: { bn: "আদব (শিষ্টাচার)", en: "Good Manners (Adab)", ur: "آداب" },
  40: { bn: "অনুমতি প্রার্থনা", en: "Asking Permission", ur: "اجازت لینا" },
  41: { bn: "দোয়া ও যিকর", en: "Invocations (Dua)", ur: "دعائیں" },
  42: { bn: "হৃদয় নরম করা (রিকাক)", en: "Heart Softeners (Riqaq)", ur: "رقاق" },
  43: { bn: "তাকদীর (ভাগ্যলিপি)", en: "Divine Will (Qadar)", ur: "تقدیر" },
  44: { bn: "শপথ ও মানত", en: "Oaths and Vows", ur: "قسمیں اور نذریں" },
  45: { bn: "কাফফারা (প্রায়শ্চিত্ত)", en: "Expiation of Oaths", ur: "کفارہ" },
  46: { bn: "উত্তরাধিকার (ফারায়েয)", en: "Laws of Inheritance", ur: "وراثت" },
  47: { bn: "জিহাদ", en: "Fighting for the Cause of Allah (Jihad)", ur: "جہاد" },
  48: { bn: "খুমস (এক পঞ্চমাংশ)", en: "One-fifth of Booty (Khumus)", ur: "خمس" },
  49: { bn: "জিযয়া ও সন্ধি", en: "Jizyah and Mawaada'ah", ur: "جزیہ اور مصالحت" },
  50: { bn: "সৃষ্টির সূচনা", en: "Beginning of Creation", ur: "ابتدائے تخلیق" },
  51: { bn: "আম্বিয়া (নবীগণ)", en: "Prophets", ur: "انبیاء" },
  52: { bn: "মানাকিব (ফযীলত)", en: "Virtues and Merits", ur: "مناقب" },
  53: { bn: "সাহাবীদের ফযীলত", en: "Companions of the Prophet", ur: "صحابہ کے فضائل" },
  54: { bn: "আনসারদের ফযীলত", en: "Merits of Al-Ansar", ur: "انصار کے فضائل" },
  55: { bn: "মাগাযী (যুদ্ধাভিযান)", en: "Military Expeditions", ur: "غزوات" },
  56: { bn: "তাফসীর (কুরআনের ব্যাখ্যা)", en: "Prophetic Commentary on Quran", ur: "تفسیر القرآن" },
  57: { bn: "কুরআনের ফযীলত", en: "Virtues of the Quran", ur: "فضائل القرآن" },
  58: { bn: "বিবাহ (নিকাহ)", en: "Weddings (Nikah)", ur: "نکاح" },
  59: { bn: "তালাক (বিবাহ বিচ্ছেদ)", en: "Divorce", ur: "طلاق" },
  60: { bn: "খোরপোষ", en: "Maintenance", ur: "نفقہ" },
  61: { bn: "খাদ্যদ্রব্য", en: "Food", ur: "کھانے کے احکام" },
  62: { bn: "আকীকার বিধান", en: "Aqiqa Rulings", ur: "عقیقہ کے احکام" },
  63: { bn: "যবেহ ও শিকার", en: "Hunting, Slaughtering", ur: "ذبیحہ اور شکار" },
  64: { bn: "কুরবানীর বিধান", en: "Al-Adahi (Sacrifice)", ur: "قربانی کے احکام" },
  65: { bn: "পানীয়দ্রব্য", en: "Drinks", ur: "مشروبات کے احکام" },
  66: { bn: "রোগী ও চিকিৎসা", en: "Medicine", ur: "طب" },
  67: { bn: "পোশাক-পরিচ্ছদ", en: "Clothing", ur: "لباس کے احکام" },
  68: { bn: "আদব ও শিষ্টাচার", en: "Manners", ur: "آداب و اخلاق" },
  69: { bn: "অনুমতি চাওয়া", en: "Seeking Permission", ur: "اجازت" },
  70: { bn: "দোয়াসমূহ", en: "Supplications", ur: "دعاؤں کے احکام" },
  71: { bn: "রিকাক (হৃদয় গলানো)", en: "Softening of Hearts", ur: "دل نرم کرنے والے" },
  72: { bn: "তাকদীর", en: "Destiny (Qadar)", ur: "تقدیر کے مسائل" },
  73: { bn: "কসম ও মানত", en: "Oaths, Vows", ur: "قسم اور نذر" },
  74: { bn: "কসমের কাফফারা", en: "Expiation", ur: "قسم کا کفارہ" },
  75: { bn: "ফারায়েয (উত্তরাধিকার)", en: "Inheritance Laws", ur: "میراث" },
  76: { bn: "হুদূদ (দণ্ডবিধি)", en: "Limits and Punishments (Hudud)", ur: "حدود" },
  77: { bn: "দিয়াত (রক্তমূল্য)", en: "Blood Money (Diyat)", ur: "دیت" },
  78: { bn: "মুরতাদদের বিধান", en: "Dealing with Apostates", ur: "مرتدین کے احکام" },
  79: { bn: "ইকরাহ (জবরদস্তি)", en: "Coercion", ur: "اکراہ" },
  80: { bn: "কৌশল অবলম্বন", en: "Tricks", ur: "حیلے" },
  81: { bn: "স্বপ্নের ব্যাখ্যা", en: "Interpretation of Dreams", ur: "خوابوں کی تعبیر" },
  82: { bn: "ফিতনা (পরীক্ষা)", en: "Tribulations (Fitan)", ur: "فتنے" },
  83: { bn: "বিচার-ফয়সালা (আহকাম)", en: "Judgments (Ahkam)", ur: "احکام" },
  84: { bn: "আকাঙ্ক্ষা (তামান্না)", en: "Wishes", ur: "تمنا" },
  85: { bn: "একক সংবাদ (খবরে ওয়াহিদ)", en: "Information from One Person", ur: "خبر واحد" },
  86: { bn: "কুরআন ও সুন্নাহ আঁকড়ে ধরা", en: "Holding Fast to Quran & Sunnah", ur: "قرآن و سنت کا التزام" },
  87: { bn: "তাওহীদ (একত্ববাদ)", en: "Oneness of Allah (Tawhid)", ur: "توحید" },
  88: { bn: "দুআ (প্রার্থনা)", en: "Supplication", ur: "دعا" },
  89: { bn: "ক্রীতদাস আযাদ করা", en: "Manumission of Slaves", ur: "غلام آزاد کرنا" },
  90: { bn: "মুকাতাব (চুক্তিবদ্ধ দাস)", en: "Conditions of Contract", ur: "مکاتب" },
  91: { bn: "হেবা (উপহার)", en: "Gifts", ur: "ہبہ" },
  92: { bn: "সাক্ষ্যদান", en: "Witnesses", ur: "گواہی" },
  93: { bn: "সন্ধি ও সমঝোতা", en: "Peacemaking", ur: "صلح" },
  94: { bn: "শর্তাবলী", en: "Conditions", ur: "شرائط" },
  95: { bn: "অসিয়ত (উইল)", en: "Wills and Testaments", ur: "وصیت" },
  96: { bn: "ওয়াকালা (প্রতিনিধিত্ব)", en: "Representation", ur: "وکالت" },
  97: { bn: "কৃষি ও চাষাবাদ", en: "Agriculture", ur: "کھیتی باڑی" },
};
